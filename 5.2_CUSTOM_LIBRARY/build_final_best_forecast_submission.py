...
# build the submission with validation stage forecasts (raw_unit_sales), y evaluation Stage
import os
import sys
import datetime
import logging
...
class make_best_forecast_and_generate_submission:
    ...
    def run(self, submission_name, local_ergs_settings):
        try:
            ...
            elif local_ergs_settings['competition_stage'] == 'submitting_after_June_1th_using_1913days':
            ...
            np.save(''.join([local_ergs_settings['models_evaluation_path'],
                             'final_best_forecast_submission_ts_model_mse_results']), ts_model_mse)
            ...
            print('build_forecast and final submission based in best_results submodule_error: ', submodule_error)
            logger.info('error in build_forecast and final submission based in best_results submodule')
