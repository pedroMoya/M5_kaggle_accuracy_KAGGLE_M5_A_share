...
class neural_network_time_serie_schema:
    ...
    def train_and_predict(self, local_settings, local_x_train, local_y_train, local_raw_unit_sales,
                          local_model_hyperparameters, local_time_series_not_improved):
        try:
            ...
            print('starting neural network - individual time_serie training and forecasting')
            ...
            for time_serie in local_time_series_not_improved[0: 1000]:
